                    ...
                    <div className="pt-4 px-2 pb-2 h-full overflow-hidden">
                      ...
                      <div className="rounded-2xl border border-white/70 bg-white/70 shadow-sm p-2 mt-3 mb-2 w-full max-w-[200px] mx-auto text-center">
                        ...
                        <div className="mt-1 min-w-0">
                          ...
                          <h1
                            className="font-bold text-[#1e2a3a] leading-tight overflow-hidden"
                            style={{
                              display: "-webkit-box",
                              WebkitLineClamp: 2,
                          ...
                          <p className="text-[10px] text-[#5f748d] truncate">
                            {p.jobTitle || "Accountant"}
                          </p>

                          {/* Company: single-line ellipsis */}
                          <div className="flex items-center justify-center gap-1 mt-1 text-[#5f748d] text-[9px] min-w-0">
                            <Building size={11} />
                            <span className="font-semibold truncate">{p.companyName || "BeLift"}</span>
                          </div>
                        </div>
